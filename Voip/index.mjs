...
export class ActiveCall extends EventEmitter {
    ...
    constructor(callId, peerJid, engine, options = {}, phoneNumber = "") {
        ...
        this.isHorizontal = Boolean(options.isHorizontal ?? options.horizontal ?? false);
        this._videoOrientation = Number(
            options.orientation ??
            options.videoOrientation ??
            (this.isHorizontal ? 2 : 0)
        );
        this._durationMs = Number(options.durationMs ?? options.durationMS ?? 120_000);
        this._audioSource = options.audioSource ?? (this.isVideo ? "silence" : "silence");
